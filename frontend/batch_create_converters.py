...
converters = [
    {
        "filename": "gif-to-png.html",
        "title": "GIF to PNG Converter",
        "heading": "GIF to PNG Converter",
        "description": "Extract GIF frames and convert to PNG format",
        "from_format": "GIF",
        "to_format": "PNG",
        "accept": ".gif",
        "icon": "fas fa-film",
    ...
    {
        "filename": "heif-to-png.html",
        "title": "HEIF to PNG Converter",
        "heading": "HEIF to PNG Converter",
        "description": "Convert Apple HEIF/HEIC format to PNG images",
        "from_format": "HEIF",
        "to_format": "PNG",
        "accept": ".heif,.heic",
    ...
    {
        "filename": "avif-to-jpg.html",
        "title": "AVIF to JPG Converter",
        "heading": "AVIF to JPG Converter",
        "description": "Convert next-gen AVIF format to standard JPG",
        "from_format": "AVIF",
        "to_format": "JPG",
        "accept": ".avif",
        "icon": "fas fa-rocket",
    ...
    {
        "filename": "tif-to-png.html",
        "title": "TIF to PNG Converter",
        "heading": "TIF to PNG Converter",
        "description": "Convert TIFF images to PNG format",
        "from_format": "TIF/TIFF",
        "to_format": "PNG",
        "accept": ".tif,.tiff",
    ...
    {
        "filename": "svg-to-jpg.html",
        "title": "SVG to JPG Converter",
        "heading": "SVG to JPG Converter",
        "description": "Convert vector SVG graphics to JPG images",
        "from_format": "SVG",
        "to_format": "JPG",
        "accept": ".svg",
    ...
    {
        "filename": "png-to-ico.html",
        "title": "PNG to ICO Converter",
        "heading": "PNG to ICO Converter",
        "description": "Create Windows ICO icons from PNG images",
        "from_format": "PNG",
        "to_format": "ICO",
        "accept": ".png",
        "icon": "fas fa-icons",
    ...
    {
        "filename": "jpg-to-ico.html",
        "title": "JPG to ICO Converter",
        "heading": "JPG to ICO Converter",
        "description": "Create Windows ICO icons from JPG photos",
        "from_format": "JPG",
        "to_format": "ICO",
        "accept": ".jpg,.jpeg",
        "icon": "fas fa-icons",
...
print(f"\n🎉 Successfully created {len(created)} converter pages!")
print(f"Pages: {', '.join(created)}")
